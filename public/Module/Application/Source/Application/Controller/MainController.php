...
class MainController extends BaseController {
	public function indexAction() {
		...
		print 'isie6'.'->';var_dump($this->isie6());print '<br />';
		print 'isie7'.'->';var_dump($this->isie7());print '<br />';
		print 'isie8'.'->';var_dump($this->isie8());print '<br />';
		print 'isie9'.'->';var_dump($this->isie9());print '<br />';
